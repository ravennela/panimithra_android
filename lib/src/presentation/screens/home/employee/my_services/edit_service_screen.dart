                        ...
                        BlocConsumer<ServiceBloc, ServiceState>(
                          ...
                          if (state is ServiceByIdLoaded) {
                            ...
                            subCategoryController.text =
                                state.service.subCategoryName.toString();
                            categoryController.text =
                                state.service.categoryName.toString();
                            _serviceNameController.text =
                                state.service.serviceName;
                            _descriptionController.text =
                                state.service.description;
                            addInfoLine1Controller.text =
                                state.service.addInfoOne.toString();
                            addInfoLine2Controller.text =
                                state.service.addInfoTwo.toString();
                            addInfoLine3Controller.text =
                                state.service.addInfoThree.toString();
                            addressController.text =
                                state.service.address.toString();
                        ...
                        _sectionCard(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              BlocConsumer<ServiceBloc, ServiceState>(
                                listener: (context, state) {
                                  if (state is UpdateServiceError) {
                                    ToastHelper.showToast(
                                        context: context,
                                        type: 'error',
                                        title: state.message);
